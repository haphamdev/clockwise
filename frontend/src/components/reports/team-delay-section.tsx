    ...
    <div className="space-y-2">
      <div>
        ...
        <p className="text-xs text-muted-foreground">
          Shows how quickly team members log their hours. Each cell shows the
          75th percentile delay &mdash; 75% of entries were logged within this
          many days. Cells with fewer than {data?.minEntries ?? 5} entries are
          grayed out.
        </p>
      </div>
      {isLoading ? (
